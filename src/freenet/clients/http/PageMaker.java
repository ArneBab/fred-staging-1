...
public final class PageMaker {
        ...
        public enum THEME {
                BOOTSTRAP("bootstrap", "Bootstrap (Top menu)", "", false, false),
        ...
        public PageNode getPageNode(String title, ToadletContext ctx, RenderParameters renderParameters) {
                ...
                if (renderParameters.isRenderNavigationLinks()) {
                        ...
                        brandContainerDiv.addChild("img","src","static/freenet-logo-white.png");
                        brandContainerDiv.addChild("a", "href", "/", "Freenet");

                        // Add current application menu
                        HTMLNode openAppNav = navbarContainer.addChild("ul", new String[] {"class","id"}, new String[] {"nav","openAppNav"});
                        HTMLNode openAppDropdown = openAppNav.addChild("li", "class", "dropdown");
                        HTMLNode openAppLink = openAppDropdown.addChild("a","href","#","Open App");
                        openAppLink.addChild("i", "class", "icon-angle-down icon-white");
                        HTMLNode openAppDropdownMenu = openAppDropdown.addChild("ul","class","dropdown-menu pull-right");
                        HTMLNode openAppDropdownMenuItem = openAppDropdownMenu.addChild("li");
                        openAppDropdownMenuItem.addChild("a","href","#");

                        //Add the icons menu
                        HTMLNode iconsNav = navbarContainer.addChild("ul",new String[] {"class","id"},new String[] {"nav pull-right","iconsNav"});
                        HTMLNode notificationsDropdown = iconsNav.addChild("li",new String[] {"class","id"}, new String[] {"dropdown","notificationsIcon"});
                        HTMLNode notificationsDropdownA = notificationsDropdown.addChild("a",new String[] {"href","class"}, new String[] {"#","notificationIconText"});
