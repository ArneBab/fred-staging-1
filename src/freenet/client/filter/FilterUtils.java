...
public class FilterUtils {
	...
	static
	{
		...
		SVGcolorKeywords.add("mediumpurple");
		SVGcolorKeywords.add("mediumseagreen");
		SVGcolorKeywords.add("mediumslateblue");
		SVGcolorKeywords.add("mediumspringgreen");
		SVGcolorKeywords.add("mediumturquoise");
		SVGcolorKeywords.add("mediumvioletred");
		SVGcolorKeywords.add("midnightblue");
		SVGcolorKeywords.add("mintcream");
		SVGcolorKeywords.add("mistyrose");
		SVGcolorKeywords.add("moccasin");
		SVGcolorKeywords.add("navajowhite");
		SVGcolorKeywords.add("navy");
		SVGcolorKeywords.add("oldlace");
		SVGcolorKeywords.add("olive");
		SVGcolorKeywords.add("olivedrab");
		SVGcolorKeywords.add("orange");
		SVGcolorKeywords.add("orangered");
		SVGcolorKeywords.add("orchid");
		SVGcolorKeywords.add("palegoldenrod");
		SVGcolorKeywords.add("palegreen");
		SVGcolorKeywords.add("paleturquoise");
		SVGcolorKeywords.add("palevioletred");
		SVGcolorKeywords.add("papayawhip");
		SVGcolorKeywords.add("peachpuff");
		SVGcolorKeywords.add("peru");
		SVGcolorKeywords.add("pink");
		SVGcolorKeywords.add("plum");
		SVGcolorKeywords.add("powderblue");
		SVGcolorKeywords.add("purple");
		SVGcolorKeywords.add("red");
		SVGcolorKeywords.add("rosybrown");
		SVGcolorKeywords.add("royalblue");
		SVGcolorKeywords.add("saddlebrown");
		SVGcolorKeywords.add("salmon");
		SVGcolorKeywords.add("sandybrown");
		SVGcolorKeywords.add("seagreen");
		SVGcolorKeywords.add("seashell");
		SVGcolorKeywords.add("sienna");
		SVGcolorKeywords.add("silver");
		SVGcolorKeywords.add("skyblue");
		SVGcolorKeywords.add("slateblue");
		SVGcolorKeywords.add("slategray");
		SVGcolorKeywords.add("slategrey");
		SVGcolorKeywords.add("snow");
		SVGcolorKeywords.add("springgreen");
		SVGcolorKeywords.add("steelblue");
		SVGcolorKeywords.add("tan");
