...
public class HighLevelSimpleClientImpl implements HighLevelSimpleClient, RequestClient {
	...
	public FreenetURI insertManifest(FreenetURI insertURI, HashMap<String, Object> bucketsByName, String defaultName) throws InsertException {
		...
		SimpleManifestPutter putter =
			new SimpleManifestPutter(pw, SimpleManifestPutter.bucketsByNameToManifestEntries(bucketsByName), priorityClass, insertURI, defaultName, null, getInsertContext(true), false, this, false);
		try {
	...
	public InsertContext getInsertContext(boolean forceNonPersistent) {
		return new InsertContext(
				...
				eventProducer, CAN_WRITE_CLIENT_CACHE_INSERTS, Node.FORK_ON_CACHEABLE_DEFAULT, FILTER_DATA, Compressor.DEFAULT_COMPRESSORDESCRIPTOR, EXTRA_INSERTS_SINGLE_BLOCK, EXTRA_INSERTS_SPLITFILE_HEADER, InsertContext.CompatibilityMode.COMPAT_CURRENT, false);
	}
