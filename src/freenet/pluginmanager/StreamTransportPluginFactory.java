...
public interface StreamTransportPluginFactory {
	 ...
	 */
	public StreamTransportPlugin makeTransportPlugin(TransportMode transportMode, PluginAddress pluginAddress, IOStatisticCollector collector, long startupTime) throws TransportInitException;;
